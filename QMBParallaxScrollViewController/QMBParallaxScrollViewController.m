...
- (void)enableTapGestureTopView:(BOOL)enable
{
    ...
    self.topViewGestureRecognizer.enabled = enable;
}
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate{
    BOOL pastOffset = self.foregroundScrollView.contentOffset.y - _startTopHeight > -_maxHeightBorder;

    if (!_isAnimating && pastOffset && self.state == QMBParallaxStateFullSize){
